...
<center><img src="../../assets/img/header.png"></center>
                            ...
                            <div>
                                <ul class="nav pull-right">
                                  <li class="current-page">
                                    ...
                                    <li>
                                        <a href="services.html"><i class="icon-book"></i><br />Student Portal</a>
                                    </li>
                                    <li>
		...
		<div class="wraper">
			...
			<div class="head-label">
				<div class="center" style="font-size:28px">COLLEGE OF COMPUTER STUDIES</div>
				<div class="center" style="font-size:25px">ONLINE PORTAL</div>
	...
	<div class="title">
		<div class="wraper">
			<div class="left" style="font-size:15px"><?php echo $_SESSION['student'].' - '.student($_SESSION['student'],"lastname").", ".student($_SESSION['student'],"firstname").", ".student($_SESSION['student'],"middlename")." - ".student($_SESSION['student'],"course")." ".student($_SESSION['student'],"year"); ?> <a href="../index.html">logout</a></div>
